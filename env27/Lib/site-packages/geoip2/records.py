...
class Traits(Record):
    ...
    .. attribute:: autonomous_system_number
      ...
      the City and Insights webapp service end points and the GeoIP2 Enterprise
      database.
    ...
    .. attribute:: autonomous_system_organization
      ...
      Insights webapp service end points and the GeoIP2 Enterprise database.
    ...
    .. attribute:: domain
      ...
      from the City and Insights webapp service end points and the GeoIP2
      Enterprise database.
    ...
    .. attribute:: ip_address
      ...
      is for. If you performed a "me" lookup against the webapp service, this
    ...
    .. attribute:: isp
      ...
      only available from the City and Insights webapp service end points and the
    ...
    .. attribute:: organization
      ...
      attribute is only available from the City and Insights webapp service end
