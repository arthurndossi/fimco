...
class CheckIDRequest(OpenIDRequest):
    ...
    def getCancelURL(self):
        ...
        Useful for creating a "Cancel" button on a webapp form so that operation
...
class WebResponse(object):
    """I am a response to an OpenID request in terms a webapp server understands.
...
class Decoder(object):
    """I decode an incoming webapp request in to a L{OpenIDRequest}.
    """
