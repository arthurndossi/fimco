...
====================================
    ...
    dict-like object and we hope your webapp framework provides you with one
    ...
    webapp host allow strangers to read from them, do not store your data there!
...
==================
    ...
    URL (or URL pattern) that identifies your webapp site to the user
...
class Consumer(object):
    ...
    def complete(self, query, current_url):
        ...
        @param current_url: The URL used to invoke the application.
            Extract the URL from your application's webapp
...
class AuthRequest(object):
    ...
    def getMessage(self, realm, return_to=None, immediate=False):
        ...
        @param realm: The URL (or URL pattern) that identifies your
            webapp site to the user when she is authorizing it.
